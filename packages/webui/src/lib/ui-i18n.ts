...
const EN_DISPLAY_REPLACEMENTS: Replacement[] = [
  ...
  { pattern: /작업 흐름/g, replace: "Task flow" },
  { pattern: /요청 그룹 타임라인/g, replace: "Request group timeline" },
  { pattern: /선택한 작업 제어/g, replace: "Selected task controls" },
  ...
  { pattern: /실제 오케스트레이터와 위임 제어 루프는 Phase 0003 이후 연결합니다\./g, replace: "The real orchestrator and delegation control loop will be connected after Phase 0003." },
  ...
  { pattern: /세션별\/요청별 override는 후속 Phase에서 연결합니다\./g, replace: "Session-level and request-level overrides will be added in a later phase." },
  { pattern: /시맨틱 메모리\/검색 제어면은 후속 Phase 범위입니다\./g, replace: "The semantic memory and search control surface belongs to a later phase." },
  ...
  { pattern: /고급 메모리와 시맨틱 검색 제어면은 이후 단계에서 연결합니다\./g, replace: "Advanced memory and semantic search controls will be connected in a later phase." },
]
