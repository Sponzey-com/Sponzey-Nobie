...
const ADVANCED_NAV: UiNavItem[] = [
  ...
  { path: "/advanced/ai", labelKo: "AI 연결", labelEn: "AI Connections", capabilityKey: "ai.backends" },
  { path: "/advanced/channels", labelKo: "채널", labelEn: "Channels", capabilityKey: "telegram.channel" },
  { path: "/advanced/extensions", labelKo: "연장", labelEn: "Extensions", capabilityKey: "mqtt.broker" },
...
const ADMIN_NAV: UiNavItem[] = [
  { path: "/admin", labelKo: "Admin", labelEn: "Admin", descriptionKo: "개발자 진단 도구", descriptionEn: "Developer diagnostics", adminOnly: true },
]

export function getUiNavigation(mode: UiMode, adminEnabled: boolean): UiNavItem[] {
  if (mode === "advanced" || mode === "admin") return adminEnabled ? [...ADVANCED_NAV, ...ADMIN_NAV] : ADVANCED_NAV
