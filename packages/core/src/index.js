...
// Channels
export { startChannels, TelegramChannel, TelegramChannelAdapter, SlackChannel, CHANNEL_REGISTRY_RUNTIME_FEATURE_KEY, ChannelRegistry, applyChannelConnectionSettingsCompatPatch, buildChannelRegistryRuntimeDiagnostics, buildChannelRuntimeSummary, buildCompatChannelConnectionsFromConfig, buildSettingsChannelConnectionSnapshot, buildTelegramCapabilityManifest, buildTelegramContinuationLookupCandidate, buildUnsupportedCapabilityReceipt, channelConnectionSecretsToJson, createRawPayloadRef, createTelegramChannelAdapter, defineChannelAdapter, defineChannelCapabilities, isBuiltInChannelProvider, isExternalChannelProvider, isInternalChannelSurface, isPositiveDeliveryReceipt, normalizeChannelSource, namespaceChannelIdentity, parseNamespacedChannelIdentity, persistChannelConnections, recordChannelRuntimeEvent, normalizeTelegramInboundUpdate, normalizeTelegramInteractionUpdate, resolveDeliveryReceiptStatus, resolveChannelRegistryRuntimeMode, resolveChannelSurface, resolveTelegramConnectionPolicy, sanitizeChannelContractValue, updateConnectionRuntimeHealth, validateTelegramWebhookSecretToken, createDryRunChannelSmokeExecutor, getDefaultChannelSmokeScenarios, resolveChannelSmokeReadiness, runChannelSmokeScenarios, runPersistedChannelSmokeScenarios, sanitizeChannelSmokeTrace, sanitizeChannelSmokeValue, validateChannelSmokeTrace, } from "./channels/index.js";
// Runs
