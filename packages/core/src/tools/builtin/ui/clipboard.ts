...
export const clipboardReadTool: AgentTool<Record<string, never>> = {
  name: "clipboard_read",
...
export const clipboardWriteTool: AgentTool<ClipboardWriteParams> = {
  ...
  riskLevel: "safe",
  requiresApproval: false,
  execute: async (params: ClipboardWriteParams): Promise<ToolResult> => {
    try {
