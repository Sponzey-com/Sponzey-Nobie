...
function assertAllowedPath(filePath) {
    ...
    if (!isAllowed) {
        throw new Error(`Access denied: "${resolved}" is outside the allowed paths.\n` +
