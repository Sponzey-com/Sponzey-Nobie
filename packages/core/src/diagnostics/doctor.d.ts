...
export type DoctorCheckName = "runtime.manifest" | "provider.chat" | "provider.resolver" | "provider.embedding" | "web.retrieval" | "gateway.exposure" | "credential.redaction" | "channel.telegram" | "channel.slack" | "channel.webui" | "admin.ui" | "yeonjang.mqtt" | "yeonjang.protocol" | "db.migration" | "db.migration.lock" | "prompt.registry" | "memory.fts" | "memory.vector" | "queue.backpressure" | "extension.registry" | "feature.flags" | "rollout.evidence" | "plan.drift" | "artifact.storage" | "schedule.queue" | "release.package";
