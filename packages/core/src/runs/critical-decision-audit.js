export const criticalDecisionAuditEntries = [
    {
...
export const criticalDecisionSourceScanRules = [
    {
...
export function getCriticalDecisionAuditEntry(id) {
    return criticalDecisionAuditEntries.find((entry) => entry.id === id);
}
//# sourceMappingURL=critical-decision-audit.js.map