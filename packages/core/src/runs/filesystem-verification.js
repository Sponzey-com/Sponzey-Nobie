...
export function buildFilesystemVerificationPrompt(originalRequest, mutationPaths) {
    const lines = [
...
//# sourceMappingURL=filesystem-verification.js.map