...
export function bootstrapLoopState(params, dependencies) {
    const intakeProcessed = params.skipIntake || params.reconnectNeedsClarification;
    const pendingLoopDirective = params.immediateCompletionText?.trim()
        ? {
            kind: "complete",
    ...
    if (activeWorkerRuntime && (params.requiresFilesystemMutation || params.requiresPrivilegedToolExecution)) {
        ...
        dependencies.updateRunSummary(params.runId, params.requiresFilesystemMutation
...
//# sourceMappingURL=loop-bootstrap.js.map