import { type EnterpriseTimestamp, type EnterpriseTopology, type NodeType } from "../contracts/enterprise-topology.js";
export type TopologyBeginnerPaletteKind = "task" | "decision" | "approval" | "tool" | "data" | "group";
export type TopologyTemplateEntityKind = TopologyBeginnerPaletteKind | "work_node" | "team" | "org_unit" | "position" | "person" | "process" | "system" | "tool" | "authority" | "responsibility";
...
export type TopologyFlowTemplateId = "customer-request-flow" | "approval-request-flow" | "research-review-flow" | "tool-assisted-flow" | "escalation-flow" | "blank-graph";
...
export declare const TOPOLOGY_FLOW_TEMPLATES: TopologyFlowTemplatePreset[];
export declare const TOPOLOGY_TEMPLATE_CATALOG: TopologyTemplateCatalog;
export declare function buildTopologyFlowTemplateDraft(templateId: TopologyFlowTemplateId, input?: {
    topologyId?: string;
    name?: string;
