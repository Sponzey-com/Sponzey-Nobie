...
export function buildIMessageLocalBridgeConfig(config?: IMessageConfig | undefined): LocalBridgeConfig {
  return {
...
export function buildIMessageCapabilityManifest(config?: IMessageConfig | undefined) {
...
export function buildIMessageLocalBridgeDoctor(config?: IMessageConfig | undefined): LocalBridgeDoctor {
