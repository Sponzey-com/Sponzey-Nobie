...
export function buildKakaoTalkLocalBridgeConfig(config?: KakaoTalkConfig | undefined): LocalBridgeConfig {
  return {
...
export function buildKakaoTalkLocalBridgeCapabilityManifest(config?: KakaoTalkConfig | undefined): ChannelCapabilities {
...
export function buildKakaoTalkOfficialCapabilityManifest(): ChannelCapabilities {
...
export function buildKakaoTalkLocalBridgeDoctor(config?: KakaoTalkConfig | undefined): LocalBridgeDoctor {
...
export function buildKakaoTalkOfficialDoctor(config?: KakaoTalkConfig | undefined): {
  ok: boolean
