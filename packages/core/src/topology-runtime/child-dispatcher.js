import { isTopologyChildFailureStatus, } from "./delegation-planner.js";
import { createWorkOrderRuntimeEnvelope, } from "./work-order.js";
export async function dispatchChildWorkOrders(input) {
...
function normalizeChildDispatchStatus(status) {
    if (status === "completed")
        return "completed";
...
//# sourceMappingURL=child-dispatcher.js.map