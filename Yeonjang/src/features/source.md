...
- `mouse.action`은 move / click / double_click / button_down / button_up / scroll을 한 메서드로 전달합니다.
- `keyboard.action`은 shortcut / key_press / key_down / key_up을 `action`, `key`, `modifiers`로 전달합니다.
